...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchAgents: function fetchAgents() {
      ...
      this.errors = [];
      this.error = false;
      axios.get('/agents').then(function (response) {
...
var render = function() {
  ...
  return _c(
    "modal",
    {
      attrs: { name: "booking-import-modal", width: "800px", height: "auto" },
      on: { "before-open": _vm.fetchAgents }
    },
    [
      _c("div", { staticClass: "card" }, [
        _c("form", [
          _c("div", { staticClass: "card-header" }, [
            _c("h1", [_vm._v("Import Bookings")])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "card-body" }, [
            _c("div", { staticClass: "w-full clearfix" }, [
              _c("div", { staticClass: "w-1/3 p-4 pl-10 float-left" }, [
                _c("div", { staticClass: "text-primary-black font-bold" }, [
                  _vm._v("Agent")
                ]),
                _vm._v(" "),
                _c("p", { staticClass: "text-xs text-grey-darker mt-4" }, [
                  _vm._v(
                    "Each agent has a specific file format. Please\n                            choose the correct one to avoid upload errors."
                  )
                ])
              ]),
              _vm._v(" "),
                ...
                [
                  _c("div", { staticClass: "font-semibold" }, [
                    _c("div", { staticClass: "relative" }, [
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "form-select-caret" }, [
          ...
          _c(
            "div",
            { staticClass: "card-footer flex justify-between items-center" },
            [
              _vm.error
                ...
                : _vm._e(),
              _vm._v(" "),
              !_vm.message ? _c("p") : _vm._e(),
              _vm._v(" "),
              _vm.message
                ? _c("p", { staticClass: "text-primary-dark font-semibold" }, [
                    _c("i", { staticClass: "far fa-check-circle mr-2" }),
              ...
              _c(
                ...
                {
                  staticClass:
                    "btn btn-primary bg-indigo rounded hover:bg-indigo-dark h-11 text-white font-bold p-3 inline-flex items-center",
              ...
              _c("input", {
                ref: "file",
                staticClass:
                  "cursor-pointer absolute block opacity-0 pin-r pin-t",
